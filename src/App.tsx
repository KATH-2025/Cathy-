...
export default function App() {
  ...
  return (
    <div className="relative w-screen h-[100dvh] flex items-center justify-center p-0 sm:p-4 md:p-8 overflow-hidden bg-[#E5E1D8]">
      ...
      <div className="relative w-full max-w-[1920px] md:h-[min(90vh,1080px)] md:aspect-video bg-[#E5E1D8] shadow-none md:shadow-[0_40px_100px_-20px_rgba(0,0,0,0.4)] md:rounded-sm overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-20 w-full max-w-xl md:max-w-3xl lg:max-w-4xl px-4 sm:px-8 md:px-12 pb-4 sm:pb-8 md:pb-12 h-full md:h-auto flex flex-col justify-center md:translate-y-10">
          <div className="relative">
              ...
              {(['Home', 'Portfolio', 'Websites', 'Works'] as Tab[]).map((tab, idx) => (
                <button
                  ...
                  className={`
                    ...
                    text-[8px] sm:text-[9px] md:text-[10px] lg:text-[11px] tracking-[0.05em] font-typewriter font-normal uppercase whitespace-nowrap
            ...
            <motion.div 
              layout
              className="grainy-card relative w-full aspect-auto md:aspect-[1.4/1] min-h-[550px] md:min-h-[580px] h-[75dvh] md:h-auto rounded-[4px] shadow-[0_15px_45px_rgba(0,0,0,0.2)] overflow-hidden"
            >
                  ...
                  >
                    {activeTab === 'Home' ? (
                      <div className="relative w-full h-full flex flex-col items-center sm:items-start justify-center sm:justify-start text-center sm:text-left">
                        ...
                        <div className="mt-0 sm:mt-4 sm:ml-4 flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-8">
                          <div className="flex flex-col items-center sm:items-start">
                            ...
                            <p className="font-sans text-[9px] sm:text-[11px] md:text-[12px] lg:text-[14px] uppercase tracking-[0.2em] font-semibold text-zinc-100/50 mt-2 sm:ml-1">
                            ...
                            <div className="mt-4 flex flex-wrap justify-center sm:justify-start gap-2 sm:ml-1">
                              {['#上海财经大学国际会计学', '#加州伯克利大学哈斯商学院', '#语言中日英'].map((tag) => (
                                <span 
                                  key={tag} 
                                  className="text-[8px] sm:text-[9px] md:text-[10px] lg:text-[11px] px-2 py-0.5 sm:px-3 sm:py-1 rounded-full bg-white/10 text-white/60 font-sans tracking-wider backdrop-blur-sm border border-white/5 hover:bg-white/20 hover:text-white transition-colors cursor-default"
                                >
                                  {tag}
                                </span>
                              ))}
                        ...
                        <div className="flex-1 overflow-y-auto custom-scrollbar pr-1 sm:pr-2">
                          {isLoadingResume ? (
                            ...
                            <motion.div 
                              initial={{ opacity: 0 }}
                              animate={{ opacity: 1 }}
                              className="resume-content px-4 py-6 sm:px-8 md:px-16 lg:px-24 md:py-12"
                      ...
                      <div className="relative w-full h-full flex flex-col p-4 sm:p-6 overflow-hidden">
                        ...
                        <div className="flex flex-col gap-4 sm:gap-8 overflow-y-auto custom-scrollbar pr-1 sm:pr-3">
                      ...
                      <div className="relative w-full h-full flex flex-col p-4 sm:p-6 overflow-hidden">
                        ...
                        <div className="flex flex-col gap-4 sm:gap-6 overflow-y-auto custom-scrollbar pr-1 sm:pr-3 pb-8">
